...
APPS = nsqd nsqlookupd nsqadmin nsq_to_nsq nsq_to_file nsq_to_http nsq_tail nsq_stat to_nsq nsq_to_filebeat nsq_to_request nsq_to_rest producer_test
all: $(APPS)
...
$(BLDDIR)/nsq_to_filebeat: 	$(wildcard apps/nsq_to_filebeat/*.go nsq/*.go internal/*/*.go)
$(BLDDIR)/nsq_to_request: 	$(wildcard apps/nsq_to_request/*.go nsq/*.go internal/*/*.go)
$(BLDDIR)/nsq_to_rest:    	$(wildcard apps/nsq_to_rest/*.go nsq/*.go internal/*/*.go)
$(BLDDIR)/producer_test:	$(wildcard apps/producer_test/*.go nsq/*.go internal/*/*.go)
